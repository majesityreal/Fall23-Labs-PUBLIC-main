...
scatterplotSvg = d3.select('#chart-svg')
...
d3.csv('cars.csv').then(function(data) {
    ...
    function updateScatterplot() {
        ...
        circles.enter()
            ...
            .attr('fill', function(d) { return colorScale(d.cylinders); });
    ...
    if(e) {
        ...
        svg.selectAll(".dot")
            .classed("hidden", function(d){
                return e[0][0] > xScale(d[scatterplotSvg.x]) || xScale(d[scatterplotSvg.x]) > e[1][0]
                    || e[0][1] > yScale(d[scatterplotSvg.y]) || yScale(d[scatterplotSvg.y]) > e[1][1];
            })
